...
def main():
    ...
    reg_init=GradientBoostingRegressor(alpha=0.45,learning_rate=0.1,loss='quantile',
                                   max_depth=3,max_features='auto',
                                   min_samples_leaf=5,min_samples_split=2,
                                   n_estimators=100,verbose=10,random_state=13)
    ...
    reg=GradientBoostingRegressor(alpha=0.45,learning_rate=0.1,loss='quantile',
                                   max_depth=3,max_features='auto',
                                   min_samples_leaf=5,min_samples_split=2,
